...
public class StringUtilities {
    ...
    public static String getSuffix(String input) {
        ...
        if (length < 3) {
            throw new IllegalArgumentException("input needs to be at least 3 in length");
        }
    ...
    public static Character getMiddleCharacter(String inputValue) {
        ...
        return inputValue.charAt(length % 2 == 0 ? inputValue.length() / 2 - 1 : inputValue.length() / 2);
    }
